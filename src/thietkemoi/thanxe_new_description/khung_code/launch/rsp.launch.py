...
def generate_launch_description():
    ...
    xacro_path = os.path.join(get_package_share_directory(pkg_name), 'urdf', 'ten_file_xacro.xacro') #Ghi tên file xacro cần launch vào
    
    # Đường dẫn file Config (Combined)
    combined_config_path = os.path.join(get_package_share_directory(pkg_name), 'config', 'ten_file_controller.yaml') #Ghi tên file yaml chứa các controller
